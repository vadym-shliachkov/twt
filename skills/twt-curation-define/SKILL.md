...
category: curation
description: (v1.1.4) Decide keep/skip/elevate per content item; reconcile reusable facts into facts.md; produce inventory.md and per-page outlines
version: 1.1.4
