...
surface: command
category: meta
description: (v1.0.3) Agentic skill harness — derive frozen criteria, run a skill from the working tree, grade blind, optionally fix, re-run bounded (marketplace-dev only)
version: 1.0.3
