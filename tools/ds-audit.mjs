...
import {
  normUrl, sameHost, fetchUrl, extractLinks, stylesheetHrefs,
  collectCss, detectRootFontPx, looksJsRendered,
} from './lib/site-fetch.mjs';

// Re-exported so existing consumers (tests, ds-shots.mjs) that import these
// helpers from ds-audit.mjs keep working after the move to lib/site-fetch.mjs.
export { normUrl, sameHost, fetchUrl, extractLinks, stylesheetHrefs, collectCss, detectRootFontPx, looksJsRendered };
