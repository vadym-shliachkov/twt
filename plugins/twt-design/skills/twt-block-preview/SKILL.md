...
family: block-preview
role: tool
unit: twt-design
description: (v1.0.4) Screenshot an HTML file or URL — full page or a specific CSS-selector element; also runs batch block-capture for a design-system audit dir
version: 1.0.4
model: haiku
effort: low
