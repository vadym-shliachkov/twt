...
const NODES = [
  { phase: 'pre-design', rerun: '/twt-positioning',
    ...
    from: ['pre-design/brand/brand-brief.md', 'pre-design/content/fetched'] },
  { phase: 'pre-design', rerun: '/twt-pre-design --only ia',
    outputs: ['pre-design/ia/sitemap.md', 'pre-design/ia/functional-scope.md'],
    from: ['pre-design/positioning/positioning.md', 'pre-design/content/fetched'] },
  { phase: 'pre-design', rerun: '/twt-pre-design --only curation',
    outputs: ['pre-design/curation/inventory.md', 'pre-design/curation/outlines'],
    from: ['pre-design/content/fetched', 'pre-design/brand/brand-brief.md', 'pre-design/ia/sitemap.md'] },
  ...
  { phase: 'design', rerun: '/twt-design --only component',
    outputs: ['design/design-system/component/components.md'],
    from: ['design/design-system/tokens.md', 'pre-design/ia/sitemap.md', 'pre-design/curation/outlines'] },
  { phase: 'design', rerun: '/twt-design --only layout',
    outputs: ['design/layout/layouts'],
    from: ['pre-design/ia/sitemap.md', 'pre-design/curation/outlines', 'design/design-system/component/components.md'] },
  { phase: 'design', rerun: '/twt-design --only mockup',
    outputs: ['design/mockup/pages', 'design/mockup/styles.css'],
    from: ['design/layout/layouts', 'design/design-system/component/components.md', 'design/design-system/tokens.css',
           'pre-design/curation/inventory.md', 'pre-design/curation/outlines'] },
  { phase: 'design', rerun: '/twt-design (synthesis)',
    outputs: ['design/design-brief.md'],
    from: ['design/design-system/tokens.md', 'design/design-system/component/components.md',
           'design/layout/layouts', 'design/mockup/index.html'] },
  { phase: 'develop', rerun: '/twt-inherit-define',
    outputs: ['inherited/conventions.md', 'inherited/exemplars.md', 'inherited/token-map.md', 'inherited/host-style.json'],
    from: ['inherited/detection.json'] },
  { phase: 'develop', rerun: '/twt-develop (or /twt-site-dev)',
    ...
    from: ['design/design-brief.md', 'design/mockup/pages', 'design/layout/layouts',
           'design/design-system/component/components.md', 'design/design-system/tokens.css'] },
  { phase: 'develop', rerun: '/twt-develop (or /twt-site-dev)',
